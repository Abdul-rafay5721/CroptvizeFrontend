    ...
    return (
        <div className="relative">
            <div className="max-w-7xl mx-auto flex flex-col items-center gap-4 text-center md:gap-10 py-12 md:py-16 xl:px-0 px-4">
                ...
                <div className="relative w-full max-w-4xl overflow-hidden rounded-lg bg-gradient-to-b from-primary/20 to-primary/0 p-2">
                    <image
                        src="https://picsum.photos/id/1003/800/400"
                        alt="Dashboard Preview"
                        width={800}
                        height={400}
                        className="rounded border bg-background shadow-xl"
                    />
